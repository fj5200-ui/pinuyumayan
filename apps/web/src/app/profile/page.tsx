        ...
        <div className={`max-w-4xl mx-auto px-4 py-12 md:py-16 transition-all duration-1000 ${heroVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          ...
          <div className={`grid grid-cols-4 gap-4 mt-8 transition-all duration-700 delay-300 ${heroVisible ? "opacity-100" : "opacity-0"}`}>
            {[
              ...
              { icon: "", value: follows.length, label: "追蹤" },
            ...
            <div className="p-6">
              {editing ? (
                <div className="max-w-md space-y-4">
                  <h3 className="font-bold dark:text-gray-100 text-lg mb-4">編輯個人資料</h3>
                  <div>
                ...
                <div className="space-y-0 divide-y dark:divide-[#333]">
                  {[
                    ...
                    { label: "會員天數", value: `${memberDays} 天`, icon: "" },
                  ].map(item => (
                ...
                <div className="grid md:grid-cols-2 gap-3">
                  {follows.map(f => (
                    <Link key={f.id} href={`/tribes/${f.tribeId}`}
                      ...
                      <div className="w-10 h-10 bg-green-100 dark:bg-green-900/30 rounded-[var(--radius-md)] flex items-center justify-center text-lg shrink-0"></div>
                      <div className="flex-1 min-w-0">
