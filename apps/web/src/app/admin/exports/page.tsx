...
const EXPORT_TYPES = [
  ...
  { id: "tribes", name: "部落", icon: "", description: "匯出部落資料（名稱、傳統名、區域、人口、座標）", color: "bg-orange-50 dark:bg-orange-900/20 border-orange-200 dark:border-orange-800" },
];
  ...
  return (
    <div>
      ...
      <div className="mt-8 bg-[var(--cream)] dark:bg-[#1a1a1a]/50 rounded-[var(--radius-md)] p-6 border dark:border-[#333]">
        <h3 className="font-bold dark:text-gray-100 mb-2">匯出說明</h3>
