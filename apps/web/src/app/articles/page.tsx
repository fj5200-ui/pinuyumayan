...
async function getArticles() {
  try { const r = await fetch(`${API}/api/articles`, { next: { revalidate: 60 } }); return (await r.json()) || { articles: [] }; } catch { return { articles: [] }; }
}

export const metadata = { title: "文化誌 — Pinuyumayan", description: "卑南族文化文章與深度報導" };
...
export default async function ArticlesPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12">
      <div className="mb-10">
        <h1 className="text-4xl font-bold text-stone-800">📝 文化誌</h1>
        <p className="text-stone-500 mt-2 text-lg">深入了解卑南族文化的各個面向</p>
      </div>
