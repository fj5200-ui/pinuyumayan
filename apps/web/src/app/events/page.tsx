...
export default function EventsPage() {
  ...
  useEffect(() => { api.get<any>("/api/events").then(d => { setEvents(d.events || []); setLoading(false); }).catch(() => setLoading(false)); }, []);

  return (
    <div className="max-w-7xl mx-auto px-4 py-12">
      <div className="mb-10"><h1 className="text-4xl font-bold text-stone-800">🎉 活動祭典</h1><p className="text-stone-500 mt-2 text-lg">卑南族的文化活動、祭典與工作坊</p></div>
