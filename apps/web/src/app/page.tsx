        ...
        <>
          ...
          <section className="max-w-7xl mx-auto px-4 py-16">
            <div className="flex items-center justify-between mb-8">
              ...
              <div className="flex gap-3">
                <Link href="/language/quiz" className="text-amber-700 dark:text-amber-400 hover:text-amber-800 font-medium">🎯 測驗 →</Link>
                <Link href="/language" className="text-amber-700 dark:text-amber-400 hover:text-amber-800 font-medium">更多詞彙 →</Link>
              </div>
            </div>
          ...
          <section className="bg-gradient-to-r from-amber-50 to-orange-50 dark:from-stone-800/50 dark:to-stone-800/30 py-16">
            <div className="max-w-7xl mx-auto px-4">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {events.map((e: any) => (
                  <div key={e.id} className="bg-white dark:bg-stone-800 rounded-xl shadow-sm p-6 hover:shadow-md transition border dark:border-stone-700">
                    ...
                    <h3 className="font-bold text-lg mt-2 dark:text-stone-100">{e.title}</h3>
